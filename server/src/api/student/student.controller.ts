...
export class StudentController {
  ...
  @Patch('evaluate-for-admin/:id')
  @ApiOperation({ summary: 'Evaluate student for admin and superadmin' })
  @accessRoles(Roles.ADMIN, Roles.SUPER_ADMIN)
  evaluateForAdmin(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() evaluateDto: EvaluateDto,
  ) {
    return this.studentService.evaluateGradeForAdmin(id, evaluateDto);
  }
